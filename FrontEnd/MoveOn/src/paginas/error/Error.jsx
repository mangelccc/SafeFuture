...
const Error = () => {
  return (
    <div className="flex flex-col items-center justify-start mt-8 mb-14 bg-white text-black dark:bg-black1 dark:text-white transition-colors">
      ...
      <Link
        to="/"
        className="px-6 py-3 rounded-xl bg-gold text-black font-semibold shadow-md hover:bg-purple hover:text-white transition-colors dark:bg-purple dark:text-white dark:hover:bg-gold dark:hover:text-black"
      >
        Volver al inicio
      </Link>
    </div>
